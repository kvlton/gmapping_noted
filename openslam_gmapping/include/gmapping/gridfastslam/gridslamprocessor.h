...
namespace GMapping {
  ...
  */
   ...
   */
    struct TNode
    {
      ...
      */
      ...
      const RangeReading* reading; // 当前轨迹节点 对应的激光数据
    ...
    struct Particle
    {
      ...
      */
      ...
      TNode* node; // 当前粒子的轨迹树，每一个粒子都有一颗轨迹树
    };
  ...
  protected:
    ...
    /**the laser beams*/
    unsigned int m_beams; // 一帧激光的激光束的数量
    ...
    std::vector<double> m_weights; // 所有粒子的权重
